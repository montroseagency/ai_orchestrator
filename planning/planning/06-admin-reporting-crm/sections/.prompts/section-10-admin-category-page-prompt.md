...
Generate content for section `section-10-admin-category-page` (filename: `section-10-admin-category-page.md`).
...
for `section-10-admin-category-page` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-10-admin-category-page.md`
