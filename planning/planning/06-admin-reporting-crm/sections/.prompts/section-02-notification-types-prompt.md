...
Generate content for section `section-02-notification-types` (filename: `section-02-notification-types.md`).
...
for `section-02-notification-types` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-02-notification-types.md`
