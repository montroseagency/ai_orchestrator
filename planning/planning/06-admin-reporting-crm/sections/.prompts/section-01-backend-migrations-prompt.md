...
Generate content for section `section-01-backend-migrations` (filename: `section-01-backend-migrations.md`).
...
for `section-01-backend-migrations` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-01-backend-migrations.md`
