...
Generate content for section `section-07-export-api` (filename: `section-07-export-api.md`).
...
for `section-07-export-api` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-07-export-api.md`
