...
Generate content for section `section-03-client-report-api` (filename: `section-03-client-report-api.md`).
...
for `section-03-client-report-api` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-03-client-report-api.md`
