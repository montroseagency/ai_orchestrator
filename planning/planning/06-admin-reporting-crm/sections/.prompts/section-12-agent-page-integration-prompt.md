...
Generate content for section `section-12-agent-page-integration` (filename: `section-12-agent-page-integration.md`).
...
for `section-12-agent-page-integration` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-12-agent-page-integration.md`
