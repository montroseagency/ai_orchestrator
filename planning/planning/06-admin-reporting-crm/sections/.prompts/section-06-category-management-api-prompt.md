...
Generate content for section `section-06-category-management-api` (filename: `section-06-category-management-api.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/claude-plan.md` - Full implementation plan
2. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-category-management-api` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-06-category-management-api.md`
