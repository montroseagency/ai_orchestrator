...
Generate content for section `section-11-agent-resubmission` (filename: `section-11-agent-resubmission.md`).
...
for `section-11-agent-resubmission` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\06-admin-reporting-crm/sections/section-11-agent-resubmission.md`
