...
Generate content for section `section-07-entry-animation` (filename: `section-07-entry-animation.md`).
...
for `section-07-entry-animation` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/section-07-entry-animation.md`
