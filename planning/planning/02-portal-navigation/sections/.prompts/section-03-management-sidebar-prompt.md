...
Generate content for section `section-03-management-sidebar` (filename: `section-03-management-sidebar.md`).
...
for `section-03-management-sidebar` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/section-03-management-sidebar.md`
