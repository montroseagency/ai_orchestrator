...
Generate content for section `section-01-gateway-link` (filename: `section-01-gateway-link.md`).
...
for `section-01-gateway-link` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/section-01-gateway-link.md`
