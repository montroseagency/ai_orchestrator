...
Generate content for section `section-02-portal-detection` (filename: `section-02-portal-detection.md`).
...
for `section-02-portal-detection` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/section-02-portal-detection.md`
