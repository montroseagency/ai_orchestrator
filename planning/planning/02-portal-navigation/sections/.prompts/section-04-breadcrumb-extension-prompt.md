...
Generate content for section `section-04-breadcrumb-extension` (filename: `section-04-breadcrumb-extension.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/claude-plan.md` - Full implementation plan
2. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-breadcrumb-extension` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\02-portal-navigation/sections/section-04-breadcrumb-extension.md`
