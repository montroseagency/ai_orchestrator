...
Generate content for section `section-05-task-modal` (filename: `section-05-task-modal.md`).
...
for `section-05-task-modal` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/section-05-task-modal.md`
