...
Generate content for section `section-04-list-view` (filename: `section-04-list-view.md`).
...
for `section-04-list-view` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/section-04-list-view.md`
