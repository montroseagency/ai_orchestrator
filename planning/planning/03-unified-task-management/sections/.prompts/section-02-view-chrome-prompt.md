...
Generate content for section `section-02-view-chrome` (filename: `section-02-view-chrome.md`).
...
for `section-02-view-chrome` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/section-02-view-chrome.md`
