...
Generate content for section `section-03-kanban-view` (filename: `section-03-kanban-view.md`).
...
for `section-03-kanban-view` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/section-03-kanban-view.md`
