...
Generate content for section `section-06-page-composition` (filename: `section-06-page-composition.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/claude-plan.md` - Full implementation plan
2. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-page-composition` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\03-unified-task-management/sections/section-06-page-composition.md`
