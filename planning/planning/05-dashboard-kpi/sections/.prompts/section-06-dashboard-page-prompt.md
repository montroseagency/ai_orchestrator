...
Generate content for section `section-06-dashboard-page` (filename: `section-06-dashboard-page.md`).
...
for `section-06-dashboard-page` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/section-06-dashboard-page.md`
