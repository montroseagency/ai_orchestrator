...
Generate content for section `section-03-dashboard-stats` (filename: `section-03-dashboard-stats.md`).
...
for `section-03-dashboard-stats` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/section-03-dashboard-stats.md`
