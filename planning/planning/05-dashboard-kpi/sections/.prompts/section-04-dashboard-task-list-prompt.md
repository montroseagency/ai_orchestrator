...
Generate content for section `section-04-dashboard-task-list` (filename: `section-04-dashboard-task-list.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/claude-plan.md` - Full implementation plan
2. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/claude-plan-tdd.md` - Test stubs for each section
3. `C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-dashboard-task-list` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/section-04-dashboard-task-list.md`
