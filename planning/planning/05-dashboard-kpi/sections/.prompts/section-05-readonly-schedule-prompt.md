...
Generate content for section `section-05-readonly-schedule` (filename: `section-05-readonly-schedule.md`).
...
for `section-05-readonly-schedule` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/section-05-readonly-schedule.md`
