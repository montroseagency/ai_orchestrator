...
Generate content for section `section-02-current-task-kpi` (filename: `section-02-current-task-kpi.md`).
...
for `section-02-current-task-kpi` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\05-dashboard-kpi/sections/section-02-current-task-kpi.md`
