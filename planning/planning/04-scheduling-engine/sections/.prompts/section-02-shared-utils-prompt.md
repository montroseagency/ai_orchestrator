...
Generate content for section `section-02-shared-utils` (filename: `section-02-shared-utils.md`).
...
for `section-02-shared-utils` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-02-shared-utils.md`
