...
Generate content for section `section-12-status-bar` (filename: `section-12-status-bar.md`).
...
for `section-12-status-bar` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-12-status-bar.md`
