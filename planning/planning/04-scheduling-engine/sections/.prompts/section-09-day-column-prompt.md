...
Generate content for section `section-09-day-column` (filename: `section-09-day-column.md`).
...
for `section-09-day-column` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-09-day-column.md`
