...
Generate content for section `section-04-data-hook` (filename: `section-04-data-hook.md`).
...
for `section-04-data-hook` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-04-data-hook.md`
