...
Generate content for section `section-08-grid-structure` (filename: `section-08-grid-structure.md`).
...
for `section-08-grid-structure` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-08-grid-structure.md`
