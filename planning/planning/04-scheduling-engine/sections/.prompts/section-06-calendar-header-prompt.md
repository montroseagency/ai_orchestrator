...
Generate content for section `section-06-calendar-header` (filename: `section-06-calendar-header.md`).
...
for `section-06-calendar-header` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-06-calendar-header.md`
