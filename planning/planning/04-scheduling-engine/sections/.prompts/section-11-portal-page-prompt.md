...
Generate content for section `section-11-portal-page` (filename: `section-11-portal-page.md`).
...
for `section-11-portal-page` to understand what this section should contain.
...
`C:\Users\User\Documents\GitHub\Montrroase_website\planning\04-scheduling-engine/sections/section-11-portal-page.md`
