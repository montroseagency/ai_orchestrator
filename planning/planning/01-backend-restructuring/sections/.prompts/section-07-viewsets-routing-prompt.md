...
Generate content for section `section-07-viewsets-routing` (filename: `section-07-viewsets-routing.md`).
...
for `section-07-viewsets-routing` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-07-viewsets-routing.md`
