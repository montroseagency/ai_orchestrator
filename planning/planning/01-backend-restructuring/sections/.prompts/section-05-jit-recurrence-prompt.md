...
Generate content for section `section-05-jit-recurrence` (filename: `section-05-jit-recurrence.md`).
...
for `section-05-jit-recurrence` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-05-jit-recurrence.md`
