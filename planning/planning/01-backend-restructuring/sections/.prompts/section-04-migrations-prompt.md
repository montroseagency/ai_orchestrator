...
Generate content for section `section-04-migrations` (filename: `section-04-migrations.md`).
...
for `section-04-migrations` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-04-migrations.md`
