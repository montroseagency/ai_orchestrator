...
Generate content for section `section-02-agentglobaltask-model` (filename: `section-02-agentglobaltask-model.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/claude-plan.md` - Full implementation plan
2. `/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/claude-plan-tdd.md` - Test stubs for each section
3. `/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-agentglobaltask-model` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-02-agentglobaltask-model.md`
