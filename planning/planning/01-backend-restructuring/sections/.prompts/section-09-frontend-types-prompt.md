...
Generate content for section `section-09-frontend-types` (filename: `section-09-frontend-types.md`).
...
for `section-09-frontend-types` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-09-frontend-types.md`
