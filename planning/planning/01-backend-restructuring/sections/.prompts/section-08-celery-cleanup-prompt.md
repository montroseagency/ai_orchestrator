...
Generate content for section `section-08-celery-cleanup` (filename: `section-08-celery-cleanup.md`).
...
for `section-08-celery-cleanup` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-08-celery-cleanup.md`
