...
Generate content for section `section-06-serializers` (filename: `section-06-serializers.md`).
...
for `section-06-serializers` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-06-serializers.md`
