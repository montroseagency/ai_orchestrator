...
Generate content for section `section-10-frontend-api` (filename: `section-10-frontend-api.md`).
...
for `section-10-frontend-api` to understand what this section should contain.
...
`/home/ubuntu/Montrroase_website/planning/01-backend-restructuring/sections/section-10-frontend-api.md`
